                    ...
                    <Carousel.Item key={index} className='carousel-trending'>
                        <Link to={`${pathname}/event_${index}`}>
                            ...
                            <Carousel.Caption className="text-start">
                                ...
                                <div className="mt-4" >
                                    <button className='btn btn-light  btn-play me-2' style={{color:"hotpink", fontWeight:'bold'}} >{t("PLAY ")}
                                        <span >
                                    ...
                                    <button className="btn btn-light text-primary" >
                                        <svg xmlns="http://www.w3.org/2000/svg" style={{color:"hotpink", fontWeight:'bold'}} width="16" height="16" fill="currentColor" className="bi bi-share" viewBox="0 0 16 16">
