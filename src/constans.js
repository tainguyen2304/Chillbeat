...
import logo from './assets/images/logo_chillbeat.png'
...
// data NAV-TABS
const albumMusic = <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className="bi bi-music-note-list" viewBox="0 0 16 16">
...
export const ALBUM_MUSIC = `${HOME_PAGE}/listen_to_music`;
